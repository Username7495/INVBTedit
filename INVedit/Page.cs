...
namespace INVedit
{
	public class Page : TabPage
	{
		...
		public static Image fire,arrow;
		...
		public Page()
		{
			...
			if (resources == null) {
				resources = new ResourceManager("INVBTedit.INVedit.Resources", GetType().Assembly);
				...
				arrow = (Image)resources.GetObject("arrow");
			}
			
			boxInventory = new GroupBox(){ Text = NameINV(), Location = new Point(6, 6), Size = new Size(461, 285) };
			Controls.Add(boxInventory);
			
			ControlsINV(boxInventory);
			...
			boxCount.Minimum = -128;
			boxCount.Maximum = 127;
		...
		public virtual string NameINV() {
			return "Inventory";
		}
		
		public virtual void ControlsINV(GroupBox boxInventory) {
		}
		
		public virtual void CreateINV() {
		...
		public void CreateSlot(byte slot, int x, int y)
		{
		...
		void ValueChanged(object sender, EventArgs e)
		{
			...
			if (box == boxCount) selected.Item.Count = (sbyte)box.Value;
			selected.Refresh();
